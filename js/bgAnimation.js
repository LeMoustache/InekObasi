var circles = [],
    ...
    colors = ['rgb(241, 42, 17,0.5'],
    minSize = 30,                                        // the minimum size of the circles in px
    maxSize = 100,                                       // the maximum size of the circles in px
    numCircles = 5,                                   // the number of circles
